cenozoApp.defineModule({
  ...
  create: (module) => {
      ...
      function (CnReviewAnswerModelFactory) {
        return {
          ...
          controller: function ($scope) {
            if (angular.isUndefined($scope.reviewAnswerModel))
              $scope.reviewAnswerModel = CnReviewAnswerModelFactory.root;
            $scope.refresh = function () {
              $scope.reviewAnswerModel.entryModel.onView();
            };
            $scope.refresh();
          },
        };
        ...
        var object = function (parentModel) {
          angular.extend(object, {
            ...
            onView: async function () {
              ...
              try {
                var response = await CnHttpFactory.instance({
                  path: [
                    "review",
                    this.parentModel.getQueryParameter("identifier", true),
                    "review_answer",
                  ].join("/"),
                  data: {
                    select: {
                      column: [
                        ...
                        "answer",
                        "comment",
                        { table: "review_type_question", column: "question" },
                      ],
                    },
            ...
            patch: async function (property, id) {
              ...
              try {
                var data = {};
                data[property] = this.answerList.findByProperty("id", id)[
                  property
                ];
                ...
                if ("answer" == property && null == data.answer)
    ...
    cenozo.providers.factory("CnReviewAnswerModelFactory", [
      "CnBaseModelFactory",
      "CnReviewAnswerEntryFactory",
      "CnReviewAnswerListFactory",
      "CnReviewAnswerViewFactory",
      function (
        CnBaseModelFactory,
        CnReviewAnswerEntryFactory,
        CnReviewAnswerListFactory,
