  ...
  create: (module) => {
    angular.extend(module, {
      identifier: {
        parent: [
          ...
          {
            subject: "amendment_type",
            column: "amendment_type_id",
          },
        ],
      },
      name: {
        singular: "amendment type fee schedule",
        plural: "amendment type fee schedules",
        possessive: "amendment type fee schedule's",
      },
      columnList: {
    ...
    module.addInputGroup("", {
      amendment_type: {
        ...
        column: "amendment_type.reason_en",
        type: "string",
        isConstant: true,
      },
      fee_schedule: {
      ...
      fee_international: { title: "International Fee ($)", type: "string", format: "integer" },
    });
  },
});
