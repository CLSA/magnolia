cenozoApp.defineModule({
  ...
  create: (module) => {
    angular.extend(module, {
      ...
      columnList: {
        filename: { column: "reqn_document.filename", title: "Name" },
      },
      defaultOrder: {
        column: "reqn_document.filename",
        reverse: true,
      },
    });
    ...
    /* ############################################################################################## */
    cenozo.providers.factory("CnReqnDocumentAddFactory", [
      "CnBaseAddFactory",
    ...
    /* ############################################################################################## */
    cenozo.providers.factory("CnReqnDocumentViewFactory", [
      "CnBaseViewFactory",
      "CnHttpFactory",
