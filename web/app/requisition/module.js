define( [ 'coapplicant', 'reference' ].reduce( function( list, name ) {
      ...
      var object = function( parentModel, root ) {
        ...
        this.submit = function() {
          return CnModalConfirmFactory.instance( {
            title: cenozoApp.translate( lookupData, 'misc.pleaseConfirm', this.record.language ),
            message: cenozoApp.translate( lookupData, 'misc.submitWarning', this.record.language )
            ...
            if( response ) {
              ...
              if( 0 < errorCount ) {
                ...
                CnModalMessageFactory.instance( {
                  title: cenozoApp.translate( lookupData, 'misc.missingFieldTitle', self.record.language ),
                  message: cenozoApp.translate( lookupData, messageLookupCode, self.record.language ),
                  error: true
  ...
  var lookupData = {
    ...
    misc: {
      pleaseConfirm: { en: 'Please Confirm', fr: 'TRANSLATION REQUIRED' },
      ...
      missingFieldTitle: { en: 'Missing Mandatory Field', fr: 'TRANSLATION REQUIRED' },
      missingFieldMessage: {
        singular: {
