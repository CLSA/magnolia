 ...
 */
define( 'ARGUMENT_MAGNOLIA_BASE_ERRNO',   180000 );
define( 'DATABASE_MAGNOLIA_BASE_ERRNO',   280000 );
define( 'LDAP_MAGNOLIA_BASE_ERRNO',       380000 );
define( 'NOTICE_MAGNOLIA_BASE_ERRNO',     480000 );
define( 'PERMISSION_MAGNOLIA_BASE_ERRNO', 580000 );
define( 'RUNTIME_MAGNOLIA_BASE_ERRNO',    680000 );
define( 'SYSTEM_MAGNOLIA_BASE_ERRNO',     780000 );
define( 'VOIP_MAGNOLIA_BASE_ERRNO',       980000 );
