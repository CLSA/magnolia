...
( 4, "Website, technology, equipment or technique", "Site Web, technologie, équipement ou technique", NULL, NULL ),
( 5, "Invention, patent application, or license", "Invention, demande de brevet ou de licence", NULL, NULL ),
( 6, "Derived Data", "Données dérivées", "Derived variable, model, database, audio or video product, software, educational aid or curricula", "Variables dérivée, modèle, base de donnée, document audio ou vidéo, logiciel, outil ou programme éducatif" ),
