...
CREATE PROCEDURE patch_footnote()
  BEGIN
    ...
    IF @test = 0 THEN
      ...
      ( "Please note that a request to receive genomics data will incur additional costs for transfer of the data, beyond the current data access fee. (Shipping & associated fees to be determined)", "TRANSLATION REQUIRED" ),
