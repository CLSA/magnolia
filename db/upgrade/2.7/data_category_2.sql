...
CREATE PROCEDURE patch_data_category()
  BEGIN
    ...
    IF 0 = @test THEN
      ...
      ( @data_category_id, 1, "Questionnaire Data", "TRANSLATE1", 'For a detailed list of the questionnaire data variables please consult the <a href="https://www.clsa-elcv.ca/doc/3162" target="data_availability">Data Availability Table</a> on the CLSA website', 'TRANSLATE2' ),
      ( @data_category_id, 2, "Physical Assessment", "TRANSLATE3", "For a detailed list of the physical assessment variables please consult the Physical Assessments Summary Table available in the Data and Biospecimens section of the CLSA website.", "TRANSLATE4"  ),
      ( @data_category_id, 3, "Blood Biomarkers (Hematology and Chemistry)", "TRANSLATE5", 'For a detailed list of the blood biomarkers variables please consult the <a href="https://www.clsa-elcv.ca/doc/3162" target="data_availability">Data Availability Table</a> on the CLSA website.', 'TRANSLATE6' );
      ...
      ( @data_selection1_id, 1, "Socio-Demographic Characteristics", "TRANSLATE7", NULL, NULL ),
      ( @data_selection2_id, 1, "Socio-Demographic Characteristics", "TRANSLATE8", NULL, NULL ),
      ( @data_selection1_id, 2, "Lifestyle and Behaviour", "TRANSLATE9", NULL, NULL ),
      ( @data_selection2_id, 2, "Lifestyle and Behaviour", "TRANSLATE10", NULL, NULL ),
      ( @data_selection1_id, 3, "Physical Health", "TRANSLATE11", NULL, NULL ),
      ( @data_selection2_id, 3, "Physical Health", "TRANSLATE12", NULL, NULL ),
      ( @data_selection1_id, 4, "Medications", "TRANSLATE13", "Medications Module (MEDI) includes information on prescription and non-prescription medications used regularly by CLSA Comprehensive Cohort participants. Main variables include: DIN, name, dosage, frequency, start date & duration of use, reason of use.", "TRANSLATE14" ),
      ( @data_selection1_id, 5, "Psychological Health", "TRANSLATE15", NULL, NULL ),
      ( @data_selection2_id, 5, "Psychological Health", "TRANSLATE16", NULL, NULL ),
      ( @data_selection1_id, 6, "Cognition - metadata & scores", "TRANSLATE17", "Raw data are available by special request. To request raw data, please go to the Additional Data section.", "TRANSLATE18" ),
      ( @data_selection2_id, 6, "Cognition - metadata & scores", "TRANSLATE19", "Raw data are available by special request. To request raw data, please go to the Additional Data section.", "TRANSLATE20" ),
      ( @data_selection1_id, 7, "Labour Force", "TRANSLATE21", NULL, NULL ),
      ( @data_selection2_id, 7, "Labour Force", "TRANSLATE22", NULL, NULL ),
      ( @data_selection1_id, 8, "Social Health", "TRANSLATE23", NULL, NULL ),
      ( @data_selection2_id, 8, "Social Health", "TRANSLATE24", NULL, NULL );
      ...
      ( @data_selection1_id, 1, "Hematology Report", "TRANSLATE25" ),
      ( @data_selection2_id, 1, "Hematology Report", "TRANSLATE26" ),
      ( @data_selection1_id, 2, "Chemistry Report", "TRANSLATE27" );
      ...
      INSERT INTO data_detail( data_selection_id, rank, name_en, name_fr ) VALUES
      ( @data_selection1_id, 3, "Processed data, CSV format (Beta values, background corrected, normalized, and probe filtered)", "TRANSLATE28" );
    ...
    IF 0 < @test THEN
      ...
      -- create the new data-options
      INSERT INTO data_option( data_category_id, rank, name_en, name_fr, note_en, note_fr ) VALUES
      ( @data_category_id, 1, "Environmental Indicators", "TRANSLATE29", "When requesting these data, please note that if your CLSA Data and Biospecimen Request Application is approved, you will also be required to sign a Data Sharing and Use via Approved Third Party Agreement (available for consultation and download here: http://canue.ca/data/ ), and submit it to the CLSA.", "TRANSLATE30" );
      ...
      INSERT INTO data_detail( data_selection_id, rank, name_en, name_fr ) VALUES
      ( @data_selection_id, 1, "Air Quality", "TRANSLATE31" ),
      ( @data_selection_id, 2, "Neighborhood Factors", "TRANSLATE32" ),
      ( @data_selection_id, 3, "Greenness & Weather", "TRANSLATE33" );
