...
-- Wed 27 Jun 2018 10:36:37 AM EDT
...
-- -----------------------------------------------------
-- Table `magnolia`.`reqn_last_stage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`reqn_last_stage` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`reqn_last_stage` (
  `reqn_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`dsac_review`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`dsac_review` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`dsac_review` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `reqn_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- procedure update_reqn_last_stage
-- -----------------------------------------------------

USE `magnolia`;
DROP procedure IF EXISTS `magnolia`.`update_reqn_last_stage`;
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`stage_AFTER_INSERT` AFTER INSERT ON `reqn_stage` FOR EACH ROW
BEGIN
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`stage_AFTER_UPDATE` AFTER UPDATE ON `reqn_stage` FOR EACH ROW
BEGIN
  CALL update_reqn_last_stage( NEW.reqn_id );
END$$
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`stage_AFTER_DELETE` AFTER DELETE ON `reqn_stage` FOR EACH ROW
BEGIN
