...
-- -----------------------------------------------------
-- Table `magnolia`.`additional_fee_fee_schedule`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`additional_fee_fee_schedule` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `magnolia`.`amendment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`amendment` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `magnolia`.`amendment_current_reqn_version`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`amendment_current_reqn_version` (
...
-- -----------------------------------------------------
-- Table `magnolia`.`amendment_type_fee_schedule`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`amendment_type_fee_schedule` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `amendment_type_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`custom_report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`custom_report` (
...
-- -----------------------------------------------------
-- Table `magnolia`.`data_destroy`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`data_destroy` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `reqn_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`data_selection_fee_schedule`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`data_selection_fee_schedule` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `data_selection_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`deferral_note`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`deferral_note` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `reqn_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`destruction_report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`destruction_report` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `reqn_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`fee_schedule`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`fee_schedule` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript` (
  `id` INT(10) UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `reqn_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_attachment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_attachment` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_current_manuscript_version`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_current_manuscript_version` (
  `manuscript_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_deferral_note`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_deferral_note` (
  `id` INT(10) UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `manuscript_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_notice`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_notice` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `manuscript_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_notice_has_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_notice_has_user` (
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_notification`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_notification` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `manuscript_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_notification_email`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_notification_email` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_recommendation_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_recommendation_type` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_review`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_review` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `manuscript_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_review_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_review_type` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_review_type_has_manuscript_recommendation_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_review_type_has_manuscript_recommendation_type` (
  `manuscript_review_type_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_stage`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_stage` (
  `id` INT(10) UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `manuscript_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_stage_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_stage_type` (
  `id` INT(10) UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_stage_type_has_manuscript_stage_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_stage_type_has_manuscript_stage_type` (
  `manuscript_stage_type_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`manuscript_version`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`manuscript_version` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `manuscript_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`reqn_current_amendment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`reqn_current_amendment` (
  `reqn_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`reqn_current_destruction_report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`reqn_current_destruction_report` (
  `reqn_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`reqn_document`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`reqn_document` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `reqn_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`reqn_last_amendment_with_agreement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`reqn_last_amendment_with_agreement` (
  `reqn_id` INT(10) UNSIGNED NOT NULL,
  `amendment_id` INT(10) UNSIGNED NULL DEFAULT NULL,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `magnolia`.`role_has_custom_report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`role_has_custom_report` (
  `role_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`role_has_manuscript_review_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`role_has_manuscript_review_type` (
  `role_id` INT(10) UNSIGNED NOT NULL,
  `manuscript_review_type_id` INT(10) UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `magnolia`.`special_fee_waiver`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnolia`.`special_fee_waiver` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `name` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `magnolia`.`supplemental_file` (
  ...
  `name_en` VARCHAR(127) NOT NULL,
  `name_fr` VARCHAR(127) NOT NULL,
  `data_en` LONGTEXT NULL DEFAULT NULL,
  `data_fr` LONGTEXT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `uq_name_en` (`name_en` ASC),
  UNIQUE INDEX `uq_name_fr` (`name_fr` ASC))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- procedure update_reqn_current_destruction_report
-- -----------------------------------------------------

DELIMITER $$
USE `magnolia`$$
CREATE DEFINER=`patrick`@`localhost` PROCEDURE `update_reqn_current_destruction_report`(IN proc_reqn_id INT(10) UNSIGNED)
BEGIN
...
-- -----------------------------------------------------
-- procedure update_manuscript_current_manuscript_version
-- -----------------------------------------------------

DELIMITER $$
USE `magnolia`$$
CREATE DEFINER=`patrick`@`localhost` PROCEDURE `update_manuscript_current_manuscript_version`(IN proc_manuscript_id INT(10) UNSIGNED)
BEGIN
...
-- -----------------------------------------------------
-- procedure update_amendment_current_reqn_version
-- -----------------------------------------------------

DELIMITER $$
USE `magnolia`$$
CREATE DEFINER=`patrick`@`localhost` PROCEDURE `update_amendment_current_reqn_version`(IN proc_amendment_id INT(10) UNSIGNED)
BEGIN
...
-- -----------------------------------------------------
-- procedure update_reqn_current_amendment
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure update_reqn_last_amendment_with_agreement
-- -----------------------------------------------------
...
DELIMITER $$
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`additional_fee_AFTER_INSERT` AFTER INSERT ON `additional_fee` FOR EACH ROW
BEGIN
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`amendment_AFTER_INSERT` AFTER INSERT ON `amendment` FOR EACH ROW
BEGIN
  CALL update_reqn_current_amendment( NEW.reqn_id );
END$$

USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`amendment_AFTER_DELETE` AFTER DELETE ON `amendment` FOR EACH ROW
BEGIN
  CALL update_reqn_current_amendment( OLD.reqn_id );
END$$

USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`amendment_type_AFTER_INSERT` AFTER INSERT ON `amendment_type` FOR EACH ROW
BEGIN
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`data_selection_AFTER_INSERT` AFTER INSERT ON `data_selection` FOR EACH ROW
BEGIN
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `magnolia`.`destruction_report_AFTER_INSERT`
AFTER INSERT ON `magnolia`.`destruction_report`
FOR EACH ROW
BEGIN
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `magnolia`.`destruction_report_AFTER_DELETE`
AFTER DELETE ON `magnolia`.`destruction_report`
FOR EACH ROW
BEGIN
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`fee_schedule_AFTER_INSERT` AFTER INSERT ON `fee_schedule` FOR EACH ROW
BEGIN
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`manuscript_BEFORE_UPDATE` BEFORE UPDATE ON `manuscript` FOR EACH ROW
BEGIN
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `magnolia`.`manuscript_review_BEFORE_INSERT`
BEFORE INSERT ON `magnolia`.`manuscript_review`
FOR EACH ROW
BEGIN
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`manuscript_stage_AFTER_INSERT` AFTER INSERT ON `manuscript_stage` FOR EACH ROW
BEGIN
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`manuscript_stage_AFTER_DELETE` AFTER DELETE ON `manuscript_stage` FOR EACH ROW
BEGIN
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`manuscript_version_BEFORE_INSERT` BEFORE INSERT ON `manuscript_version` FOR EACH ROW
BEGIN
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`manuscript_version_AFTER_INSERT` AFTER INSERT ON `manuscript_version` FOR EACH ROW
BEGIN
  CALL update_manuscript_current_manuscript_version( NEW.manuscript_id );
END$$

USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`manuscript_version_BEFORE_UPDATE` BEFORE UPDATE ON `manuscript_version` FOR EACH ROW
BEGIN
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`manuscript_version_AFTER_DELETE` AFTER DELETE ON `manuscript_version` FOR EACH ROW
BEGIN
