...
CREATE TABLE IF NOT EXISTS `magnolia`.`reqn_version` (
  ...
  UNIQUE INDEX `uq_reqn_id_amendment_id_version` (`reqn_id` ASC, `amendment_id` ASC, `version` ASC),
...
CREATE TABLE IF NOT EXISTS `magnolia`.`review` (
  ...
  INDEX `fk_amendment_id` (`amendment_id` ASC),
  UNIQUE INDEX `uq_reqn_id_amendment_id_review_type_id` (`reqn_id` ASC, `amendment_id` ASC, `review_type_id` ASC),
...
CREATE TABLE IF NOT EXISTS `magnolia`.`stage` (
  ...
  INDEX `fk_user_id` (`user_id` ASC),
  INDEX `fk_amendment_id` (`amendment_id` ASC),
  UNIQUE INDEX `uq_reqn_id_amendment_id_stage_type_id` (`reqn_id` ASC, `amendment_id` ASC, `stage_type_id` ASC),
