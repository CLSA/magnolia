...
-- Tue 27 Nov 2018 03:21:07 PM EST
...
CREATE TABLE IF NOT EXISTS `magnolia`.`reqn` (
  ...
  `data_directory` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`data_option_detail_has_study_phase`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`data_option_detail_has_study_phase` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`data_option_detail_has_study_phase` (
  `data_option_detail_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`reqn_data_option`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`reqn_data_option` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`reqn_data_option` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `reqn_id` INT UNSIGNED NOT NULL,
