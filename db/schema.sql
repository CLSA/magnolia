...
-- Fri 12 Jan 2018 05:25:09 PM EST
...
-- -----------------------------------------------------
-- Table `magnolia`.`keyword`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`keyword` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`keyword` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `requisition_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`qnaire_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`qnaire_type` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`qnaire_type` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`qnaire`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`qnaire` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`qnaire` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  ...
  CONSTRAINT `fk_qnaire_qnaire_type_id`
    ...
    REFERENCES `magnolia`.`qnaire_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `magnolia`.`biomarker`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`biomarker` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`biomarker` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `rank` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`physical`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`physical` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`physical` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `rank` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`requisition_has_qnaire`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`requisition_has_qnaire` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`requisition_has_qnaire` (
  `requisition_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`requisition_has_physical`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`requisition_has_physical` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`requisition_has_physical` (
  `requisition_id` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_requisition_has_physical_physical_id`
    ...
    REFERENCES `magnolia`.`physical` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `magnolia`.`requisition_has_biomarker`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`requisition_has_biomarker` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`requisition_has_biomarker` (
  `requisition_id` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_requisition_has_biomarker_biomarker_id`
    ...
    REFERENCES `magnolia`.`biomarker` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
