...
-- Fri 16 Mar 2018 04:14:23 PM EDT
...
-- -----------------------------------------------------
-- Table `magnolia`.`requisition`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`requisition` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`requisition` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `user_id` INT UNSIGNED NOT NULL,
  ...
  `address` VARCHAR(511) NULL DEFAULT NULL,
  ...
  `qnaire_comment` TEXT NULL DEFAULT NULL,
  `physical` TINYINT(1) NOT NULL DEFAULT 0,
  `physical_comment` TEXT NULL DEFAULT NULL,
  `biomarker` TINYINT(1) NOT NULL DEFAULT 0,
  `biomarker_comment` TEXT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_user_id` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `magnolia`.`coapplicant` (
  ...
  CONSTRAINT `fk_coapplicant_requisition_id`
    ...
    REFERENCES `magnolia`.`requisition` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `magnolia`.`data_option_parent`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`data_option_parent` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`data_option_parent` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `name_en` VARCHAR(63) NOT NULL,
  `name_fr` VARCHAR(63) NOT NULL,
  `note_en` VARCHAR(1023) NULL DEFAULT NULL,
  `note_fr` VARCHAR(1023) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `magnolia`.`data_option_subcategory`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`data_option_subcategory` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`data_option_subcategory` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `type` ENUM('baseline', 'mcq', 'physical', 'biomarker') NOT NULL,
  `rank` INT UNSIGNED NOT NULL,
  `data_option_parent_id` INT UNSIGNED NULL DEFAULT NULL,
  `name_en` VARCHAR(63) NOT NULL,
  `name_fr` VARCHAR(63) NOT NULL,
  `note_en` VARCHAR(1023) NULL DEFAULT NULL,
  `note_fr` VARCHAR(1023) NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_data_option_subcategory_data_option_parent_id`
    ...
    REFERENCES `magnolia`.`data_option_parent` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `magnolia`.`data_option` (
  ...
  `replacement_en` VARCHAR(255) NULL DEFAULT NULL,
  `replacement_fr` VARCHAR(255) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_data_option_data_option_subcategory_id`
    ...
    REFERENCES `magnolia`.`data_option_subcategory` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `magnolia`.`requisition_has_data_option`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`requisition_has_data_option` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`requisition_has_data_option` (
  `requisition_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `magnolia`.`progress_report`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`progress_report` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`progress_report` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `requisition_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `magnolia`.`production` (
  ...
  CONSTRAINT `fk_production_progress_report_id`
    ...
    REFERENCES `magnolia`.`progress_report` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `magnolia`.`requisition_last_stage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`requisition_last_stage` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`requisition_last_stage` (
  `requisition_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- procedure update_requisition_last_stage
-- -----------------------------------------------------

USE `magnolia`;
DROP procedure IF EXISTS `magnolia`.`update_requisition_last_stage`;
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`stage_AFTER_INSERT` AFTER INSERT ON `requisition_stage` FOR EACH ROW
BEGIN
...
USE `magnolia`$$
DROP TRIGGER IF EXISTS `magnolia`.`stage_AFTER_UPDATE` $$
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`stage_AFTER_UPDATE` AFTER UPDATE ON `requisition_stage` FOR EACH ROW
BEGIN
  CALL update_requisition_last_stage( NEW.requisition_id );
END$$
...
USE `magnolia`$$
CREATE DEFINER = CURRENT_USER TRIGGER `magnolia`.`stage_AFTER_DELETE` AFTER DELETE ON `requisition_stage` FOR EACH ROW
BEGIN
