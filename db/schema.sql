...
-- Wed 01 May 2019 09:28:16 AM EDT
...
-- -----------------------------------------------------
-- Table `magnolia`.`graduate`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`graduate` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`graduate` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `user_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `magnolia`.`reqn` (
  ...
  `user_id` INT UNSIGNED NOT NULL,
  `graduate_id` INT UNSIGNED NULL DEFAULT NULL,
  `language_id` INT UNSIGNED NOT NULL,
  ...
  `revision_recommended` TINYINT(1) NOT NULL DEFAULT 0,
  ...
  INDEX `fk_graduate_id` (`graduate_id` ASC),
  ...
  CONSTRAINT `fk_reqn_deadline_id`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_reqn_graduate_id`
    FOREIGN KEY (`graduate_id`)
    REFERENCES `magnolia`.`graduate` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
