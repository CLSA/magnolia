...
-- Wed 12 Dec 2018 03:02:44 PM EST
...
CREATE TABLE IF NOT EXISTS `magnolia`.`reqn` (
  ...
  `state` ENUM('deferred', 'abandoned') NULL,
  `decision_notice` TEXT NULL,
  `deferral_note_part1_a1` TEXT NULL,
  `deferral_note_part1_a2` TEXT NULL,
  `deferral_note_part1_a3` TEXT NULL,
  `deferral_note_part1_a4` TEXT NULL,
  `deferral_note_part1_a5` TEXT NULL,
  `deferral_note_part1_a6` TEXT NULL,
  `deferral_note_part2_a` TEXT NULL,
  `deferral_note_part2_b` TEXT NULL,
  `deferral_note_part2_c` TEXT NULL,
  `deferral_note_part2_d` TEXT NULL,
  `deferral_note_part2_e` TEXT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_user_id` (`user_id` ASC),
  INDEX `fk_language_id` (`language_id` ASC),
...
CREATE TABLE IF NOT EXISTS `magnolia`.`final_report` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_reqn_version_id` (`reqn_version_id` ASC),
  UNIQUE INDEX `uq_reqn_version_id` (`reqn_version_id` ASC),
  CONSTRAINT `fk_final_report_reqn_version_id`
    FOREIGN KEY (`reqn_version_id`)
    REFERENCES `magnolia`.`reqn_version` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `magnolia`.`review` (
  ...
  UNIQUE INDEX `uq_reqn_id_review_type_id` (`review_type_id` ASC),
...
USE `magnolia`$$
DROP TRIGGER IF EXISTS `magnolia`.`reqn_version_AFTER_UPDATE` $$
USE `magnolia`$$
