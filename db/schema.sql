...
-- Tue 06 Mar 2018 04:45:37 PM EST
...
-- -----------------------------------------------------
-- Table `magnolia`.`requisition_has_stage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `magnolia`.`requisition_has_stage` ;

CREATE TABLE IF NOT EXISTS `magnolia`.`requisition_has_stage` (
  `requisition_id` INT UNSIGNED NOT NULL,
