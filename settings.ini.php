...
$SETTINGS['general']['build'] = 'c8f0af0';
...
// the location of data agreement files (defaults to magnolia/doc/data_agreement)
$SETTINGS['path']['DATA_AGREEMENT_FORM'] = str_replace( 'settings.ini.php', 'doc/data_agreement', __FILE__ );
